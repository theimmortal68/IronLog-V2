...
mid-session swap: T1 carries "Metcon 9"; T2 GS/T3 GS/T4 carry "Adipower II"
...
Ab Trainer Russian Twist) carries "Adipower II" like T2/T3.
...
def test_d5_shoe_swap_metcon_to_adipower(gen_db):
    ...
    / T3 GS / T4 carry 'Adipower II'. T1b (Hip Thrust) dropped 2026-08-12."""
