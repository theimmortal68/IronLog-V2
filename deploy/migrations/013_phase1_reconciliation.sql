...
UPDATE tierexercise SET rep_low = 8, rep_high = 8 WHERE slot_id = 'd1_t1' AND (rep_low IS NULL OR rep_low != 8 OR rep_high IS NULL OR rep_high != 8);
...
UPDATE tierexercise SET rep_low = 8, rep_high = 8 WHERE slot_id = 'd1_t3a' AND (rep_low IS NULL OR rep_low != 8 OR rep_high IS NULL OR rep_high != 8);
...
UPDATE tierexercise SET rep_low = 5, rep_high = 8 WHERE slot_id = 'd4_t1' AND (rep_low IS NULL OR rep_low != 5 OR rep_high IS NULL OR rep_high != 8);
UPDATE tierexercise SET rep_low = 5, rep_high = 8 WHERE slot_id = 'd6_g1b' AND (rep_low IS NULL OR rep_low != 5 OR rep_high IS NULL OR rep_high != 8);
UPDATE tierexercise SET rep_low = 10, rep_high = 12 WHERE slot_id = 'd5_t3d' AND (rep_low IS NULL OR rep_low != 10 OR rep_high IS NULL OR rep_high != 12);

-- TierExercise.rpe_cap: Reverse Hyper Recovery (D6 GS3).
UPDATE tierexercise SET rpe_cap = 6.0 WHERE slot_id = 'd6_g3c' AND (rpe_cap IS NULL OR rpe_cap != 6.0);

-- Tier.rest_seconds: all 18 seeded tiers, keyed by tier_label (9 buckets).
UPDATE tier SET rest_seconds = 120 WHERE tier_label = 'T1' AND (rest_seconds IS NULL OR rest_seconds != 120);
UPDATE tier SET rest_seconds = 120 WHERE tier_label = 'T1b' AND (rest_seconds IS NULL OR rest_seconds != 120);
UPDATE tier SET rest_seconds = 90 WHERE tier_label = 'T2 GS' AND (rest_seconds IS NULL OR rest_seconds != 90);
UPDATE tier SET rest_seconds = 90 WHERE tier_label = 'GS1' AND (rest_seconds IS NULL OR rest_seconds != 90);
UPDATE tier SET rest_seconds = 90 WHERE tier_label = 'GS2' AND (rest_seconds IS NULL OR rest_seconds != 90);
UPDATE tier SET rest_seconds = 60 WHERE tier_label = 'T3' AND (rest_seconds IS NULL OR rest_seconds != 60);
UPDATE tier SET rest_seconds = 60 WHERE tier_label = 'T3 GS' AND (rest_seconds IS NULL OR rest_seconds != 60);
UPDATE tier SET rest_seconds = 60 WHERE tier_label = 'T4 GS' AND (rest_seconds IS NULL OR rest_seconds != 60);
UPDATE tier SET rest_seconds = 60 WHERE tier_label = 'GS3' AND (rest_seconds IS NULL OR rest_seconds != 60);
