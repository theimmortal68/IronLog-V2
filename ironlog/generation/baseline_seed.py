...
# assist, moved from d6_g1b to its own T1 slot) and d6_g1d (Cable Bicep
# Curl, new movement filling Dips' vacated GS1 slot) have NO entry --
# intentionally needs-calibration, zero/irrelevant prior history.
#
